...
jQuery( function ( $ ) {
	...
	$('#menu-icon').click(function() {
        ...
        $('.custom-logo').toggleClass('active');
        $('#header-top').toggleClass('mobile');
        $('#header-top').toggleClass('desktop');
		return false;
	});
	...
	$('#menu-main-menu > li.menu-item-has-children').append('<div class="accordion-toggle"><span class="icon-nav-tick"></span></span></div>');

	  $('#menu-main-menu .accordion-toggle').click(function() {
		$(this).parent().find('> ul').slideToggle(400);
		$(this).toggleClass('toggle-background');
		$(this).find('.icon-nav-tick').toggleClass('toggle-rotate');
	  });
